        ...
        <div className="content">
          ...
          <div className="dataContent">
            <span className="dataName">
              Availability : <span className="dataValue">{product?.stockLevelStatus}</span>
            </span>
            <span className="dataName">
              Product Code : <span className="dataValue">{product?.sku}</span>
            </span>
            <span className="dataName">
              tags : <span className="dataValue">{product?.tags.join(", ")}</span>
            </span>
          </div>
          ...
          <div className="inputsContent">
            <div className="inputWrapper customSelect">
              <h3>COLOR</h3>
              <select onChange={handleChange} value={formData.color} name="color">
          ...
          <div className="actionsWrapper">
            <div>
              <Button disabled={isDisabled} onClick={addToCartClick} priority="medium">
                Add to cart
              </Button>
            </div>
            <div>
